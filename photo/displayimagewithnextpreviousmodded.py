...
class App:
    def __init__(self, window, window_title, file_path):
        ...
        self.btn=tkinter.Button(window, text="Previous", width=60, height=40, command=self.previous_image, borderwidth=10)
        ...
        self.btn=tkinter.Button(window, text="Blur", width=60, height=40, command=self.blur_image, borderwidth=10)
        self.btn.pack(side=tkinter.LEFT,expand = 1, fill = tkinter.BOTH)
        ...
        self.btn=tkinter.Button(window, text="Next",  width=60, height=40, command=self.next_image, borderwidth=10)
        self.btn.pack(side=tkinter.LEFT,expand = 1, fill = tkinter.BOTH)
        ...
        self.btn=tkinter.Button(window, command=self.exit, height=40, borderwidth=10)
